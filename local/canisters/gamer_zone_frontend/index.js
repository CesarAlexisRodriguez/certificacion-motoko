...
import { idlFactory } from './gamer_zone_frontend.did.js';
export { idlFactory } from './gamer_zone_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GAMER_ZONE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gamer_zone_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gamer_zone_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gamer_zone_frontend.did.js")._SERVICE>}
 */
export const gamer_zone_frontend = createActor(canisterId);
