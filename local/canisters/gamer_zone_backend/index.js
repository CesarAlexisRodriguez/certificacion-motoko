...
import { idlFactory } from './gamer_zone_backend.did.js';
export { idlFactory } from './gamer_zone_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GAMER_ZONE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gamer_zone_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gamer_zone_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gamer_zone_backend.did.js")._SERVICE>}
 */
export const gamer_zone_backend = createActor(canisterId);
